時計アプリのサンプル。時刻表示をPRINT文で実装。
背景は009_HyperSpace_2で生成した画像を利用。
SCREEN5。
時刻表示のルーチンをON INTERVALによる周期的なサブルーチンからの呼び出しではなく
パレットアニメーションのルーチンの中で呼び出すように変更。
010_HyperSpace_with_ClockApp_print_verとの比較用
...
参考情報：
Twitter：
https://twitter.com/emef220/status/1630910489239916546?s=20

MSXPen:
https://msxpen.com/codes/-NPRyoYyhKne9EO0z_Oe
